...
coroutine.wrap(
	function()
		while wait() do
			...
			if MinhLib.HueSelectionPosition == 93 then
				MinhLib.HueSelectionPosition = 0
			end
		end
	end
)()
...
MinhHubLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

function MinhLib:Window()
...
local function BloxcrusherBanner()
        ...
        AdImg.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and not closebtnhover then
                spawn(function()
                    setclipboard("https://www.youtube.com/channel/UC38IjNGJpwknMBR1i9pzsVw/playlists")
